...
# 8 Trappola web
execute @e[tag=031lat,score_031lnb_min=8,score_031lnb=8] ~ ~ ~ fill ~-2 ~2 ~-2 ~2 ~3 ~2 web 0 keep
# 9 Jumpscare Guardiano
execute @e[tag=031lat,score_031lnb_min=9,score_031lnb=9] ~ ~ ~ particle mobappearance ~ ~ ~ 1 1 1 1 1 @a[r=10]
execute @e[tag=031lat,score_031lnb_min=9,score_031lnb=9] ~ ~ ~ playsound entity.elder_guardian.curse hostile @a[r=10] ~ ~ ~ 100 1 1
## maining fatique
# 10 Deathbush bomb
execute @e[tag=031lat,score_031lnb_min=10,score_031lnb=10] ~ ~ ~ execute @p ~ ~ ~ clear @s
execute @e[tag=031lat,score_031lnb_min=10,score_031lnb=10] ~ ~ ~ execute @p ~ ~ ~ summon area_effect_cloud ~ ~ ~ {Tags:["031010"],Radius:0f,Duration:35}
execute @e[tag=031010] ~ ~ ~ summon item ~ ~ ~ {Item:{id:deadbush,Slot:0,Count:64}}
...
# - POSITIVI - #
# 254 
execute @e[tag=031lat,score_031lnb_min=255,score_031lnb=255] ~ ~ ~ summon item ~ ~2 ~ {Motion:[0.0,0.2,0.0],Item:{id:"minecraft:golden_apple",Damage:1b,Count:1b}}
# 255 Golden Apple
execute @e[tag=031lat,score_031lnb_min=255,score_031lnb=255] ~ ~ ~ summon item ~ ~2 ~ {Motion:[0.0,0.2,0.0],Item:{id:"minecraft:golden_apple",Damage:1b,Count:1b}}
