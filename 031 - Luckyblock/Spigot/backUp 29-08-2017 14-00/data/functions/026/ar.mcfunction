...
# LV 6 #
execute BisUmTo ~ ~ ~ summon item ~ ~ ~ {Item:{id:"minecraft:sign",Count:1b,tag:{CanPlaceOn:["minecraft:monster_egg"],HideFlags:16,display:{Name:"§f§o§lFind the Sign §r- §4§lLV6",Lore:["§7§lVivere senza poesia è come navigare senza..."]},BlockEntityTag:{Text4:"{\"text\":\"\"}",Text3:"{\"italic\":true,\"color\":\"white\",\"text\":\"Find The Sign\"}",Text2:"{\"underlined\":true,\"color\":\"dark_red\",\"text\":\"▶Prossimo Livello◀\"}",id:"minecraft:sign",Text1:"{\"clickEvent\":{\"action\":\"run_command\",\"value\":\"trigger LEVEL set 7\"},\"text\":\"\"}"},},Damage:0s},Fire:-1s}
